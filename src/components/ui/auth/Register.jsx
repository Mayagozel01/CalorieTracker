            ...
            <form onSubmit={handleRegister} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  <h1 className="text-2xl font-bold text-teal-700">Создать аккаунт</h1>
                  <p className="text-muted-foreground text-balance">
                    Зарегистрируйтесь, чтобы начать отслеживать калории
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <Button variant="outline" type="button" className="w-full" aria-label="Register with Google">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
                      <path
                  ...
                  <Button variant="outline" type="button" className="w-full" aria-label="Register with Meta">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5">
                      <path
